...
const Rental = (props: RentalProps) => {
  ...
  return (
    <div className="p-5 mx-auto mb-5 rounded-lg border border-solid border-gray-300">
      <Stack
      ...
      >
        ...
        <div className="text-right">
          ...
          <Typography sx={{ fontSize: "11px" }} gutterBottom>
            *{!priceNegotiable && "Non-"}Negotiable
          </Typography>
        </div>
      </Stack>
...
const KeyValue = ({ icon, text }: KeyValueProps) => (
  <div className="flex item-center mx-2 gap-1">
    {icon}
    {text}{" "}
  </div>
);
