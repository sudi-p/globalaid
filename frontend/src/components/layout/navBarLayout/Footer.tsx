...
export default function Footer() {
  return (
    <Stack
      spacing={5}
      alignItems="center"
      className="h-64 p-6 text-white bg-gray-800"
    >
      <Stack alignItems="center" justifyContent="center" direction="row">
        <div
          style={{
            backgroundImage:
              "url('https://res.cloudinary.com/dtqxwjmwn/image/upload/v1674412883/GlobalAid/GlobalAid_Logo.png')",
          }}
          className="mr-2 w-14 h-14 bg-cover bg-no-repeat bg-center"
        />
        <div>
          <div className="text-xl font-bold text-green-400 tracking-wide">
            GlobalAid
          </div>
      ...
      >
        <CopyrightIcon /> {new Date().getFullYear()} - GlobalAid Inc. All Rights
        Reserved <FooterLink text="Terms Of Use" />
