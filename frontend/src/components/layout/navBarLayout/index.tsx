        ...
        <div className={`${!email && "lg:absolute"} flex items-center`}>
          {email && (
            <Stack direction="row" spacing={2} alignItems={"center"}>
              ...
              <span className="hidden absolute lg:static lg:block text-lg text-gray-500">
                {email}
              </span>
          ...
          <div
            className="md:hidden md:absolute ml-2"
            onClick={() => setExpandMenu((prevExpandMenu) => !prevExpandMenu)}
          >
...
function NavText({ title, isActive }: NavTextProps) {
  return (
    <span
      className={`block md:mx-2 lg:mx-1 xl:mx-4 py-3 px-5 md:p-1 lg:p-2 xl:p-4 text-left text-gray-600 cursor-pointer hover:bg-gray-100 md:hover:bg-transparent no-underline ${
